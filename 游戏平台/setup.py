...
class BuildExe:
    def __init__(self):
        ...
        # 游戏作者
        self.author_name = "cxq lyg"
        # 联系电邮
        self.author_email = "80803716@qq.com"
        # 游戏版权
        self.copyright = "Copyright (c) 3000 cxq lyg."
        # 游戏描述
        self.project_description = "MyGames Description"
        # 游戏图标(None的话使用pygame的默认图标)
        self.icon_file = './image/icon.ico'
        # 额外需要拷贝的文件、文件夹(图片，音频等)
        self.extra_datas = ["bgm","image","font"]
        # 额外需要的python库名
        ...
        self.exclude_dll = ['']
        # 需要加入的py文件
        self.extra_scripts = ["FlappyBird","game2048","GreedySnake","Tetris","run"]
        # 打包Zip文件名(None的话，打包到exe文件中)
        self.zipfile_name = None
        # 生成文件夹
        self.dist_dir = 'PlayStation'
